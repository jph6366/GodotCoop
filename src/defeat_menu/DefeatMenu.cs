...
public interface IDefeatMenu : IControl
{
    event DefeatMenu.TryAgainEventHandler TryAgain;
    event DefeatMenu.MainMenuEventHandler MainMenu;
    event DefeatMenu.TransitionCompletedEventHandler TransitionCompleted;
...
public partial class DefeatMenu : Control, IDefeatMenu
{
